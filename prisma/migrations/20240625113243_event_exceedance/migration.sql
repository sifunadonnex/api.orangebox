...
INSERT INTO "new_Exceedance" ("aircraftId", "createdAt", "description", "eventStatus", "exceedanceValues", "file", "flightId", "flightPhase", "id", "parameterName", "updatedAt") SELECT "aircraftId", "createdAt", "description", "eventStatus", "exceedanceValues", "file", "flightId", "flightPhase", "id", "parameterName", "updatedAt" FROM "Exceedance";
